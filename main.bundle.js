...
module.exports = "<p>\n  Yeah <a href=\"\" (click)=\"sendMeHome()\"><strong> Take Me Back</strong></a>\n</p>\n<ul> \n  <li *ngFor=\"let goal of goals\">\n    {{goal}}\n  </li>\n</ul>"
...
var DataService = /** @class */ (function () {
    function DataService() {
        this.goals = new __WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject__["a" /* BehaviorSubject */](['The initial goal', 'Another less pertinent goal']);
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(_data) {
        ...
        this.goals = ['Ride a Lepricorn', 'navigate an asteroid field while being fired upon by the empire', 'go ice skating'];
    }
